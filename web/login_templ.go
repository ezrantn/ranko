...
func Login() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex justify-center items-center\"><form action=\"\" class=\"flex flex-col justify-center items-center gap-5 py-5\" hx-post=\"/login\" hx-target=\"#feedback\" hx-indicator=\"#indicator\"><label class=\"input input-bordered flex items-center gap-2 w-full\">Email <input type=\"email\" class=\"grow\" name=\"email\" placeholder=\"daisy@gmail.com\"></label> <label class=\"input input-bordered flex items-center gap-2 w-full\">Password <input type=\"password\" class=\"grow\" name=\"password\" placeholder=\"Password\"></label> <button class=\"btn\" type=\"submit\">Login</button><div id=\"indicator\" class=\"htmx-indicator\"><div class=\"flex justify-center items-center w-full\"><span class=\"loading loading-spinner loading-lg text-primary h-20 w-20\"></span></div></div><div id=\"feedback\"></div></form></div>")
			if templ_7745c5c3_Err != nil {
